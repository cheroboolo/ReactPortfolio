    ...
    return (
      <section id="about">
        ...
        <motion.div className="about-main" variants={aboutVariants} initial="hidden" whileInView="visible" viewport={{once:true}}>
            ...
            <motion.img className="about-img" src="https://scontent.fbeg5-1.fna.fbcdn.net/v/t1.6435-9/40527511_10215835334011611_2108058446677934080_n.jpg?_nc_cat=111&ccb=1-7&_nc_sid=174925&_nc_ohc=B6uweDhpWDoAX9DKqa9&_nc_ht=scontent.fbeg5-1.fna&oh=00_AfAO9C0fvKuiyHWsU_WAOJjHTa9jYZH12XOYomVl0yRjkw&oe=64414C25" alt="neo.jpg" initial={{x:"100vw"}} animate={{x:0}} transition={{type:"spring", delay:2, duration:3}}></motion.img>
